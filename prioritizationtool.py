...
if cost_radio=="Project Cost":
    ...
    tooling_maintenance_cost = st.selectbox("What influence does the task have on Tooling Maintenance Cost ?",
                                            (
                                            "5 – This maintenance operation will result in a cost saving of more than 50k€ in 1 year",
                                            "4 – This maintenance operation will result in a cost saving between 25k-50k€ in 1 year",
